...
//Correct colour order, WS2811's bought from AliExpress Ray are (Green, Red, Blue)
//Correct the order here to abstract it away, serial commands should be Red, Green, Blue
